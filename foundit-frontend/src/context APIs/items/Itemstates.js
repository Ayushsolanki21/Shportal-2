...
function Itemstates(props) {
  ...
  const fetchAllItems = async () => {
    // Method-1   ****API call****
    const response = await fetch(`http://localhost:8000/api/item/fetchitems`, {
      method: 'GET',
      headers: {
  ...
  const addItem = async (data) => {
    setisAdded(false);
    const response = await fetch(`http://localhost:8000/api/item/uploaditem`, {
      method: 'POST',
      headers: {
        'auth_token': localStorage.getItem('auth_token')
      },
  ...
  const deleteItem = async (id, public_id) => {
    const response = await fetch(`http://localhost:8000/api/item/deleteItem/${id}/${public_id}`, {
      method: 'DELETE',
      headers: {
        'auth_token': localStorage.getItem('auth_token'),
        'Content-Type': 'application/json'
  ...
  const editItem = async (data, id, public_id) => {
    const response = await fetch(`http://localhost:8000/api/item/updateItem/${id}/${public_id}`, {
      method: 'PUT',
      headers: {
        'auth_token': localStorage.getItem('auth_token')
      },
  ...
  const getAItem = async (id) => {
    // Method-1   ****API call****
    const response = await fetch(`http://localhost:8000/api/item/getAItem/${id}`, {
      method: 'GET',
      headers: {
        'auth_token': localStorage.getItem('auth_token')
      }
  ...
  const addplacementexp = async (company_name, profile, date, No_students, No_rounds, intern_or_fte, round_exp) => {
    const response = await fetch(`http://localhost:8000/api/item/addplacementexp`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'auth_token': localStorage.getItem('auth_token')
  ...
  const fetchPlacements = async () => {
    const response = await fetch(`http://localhost:8000/api/item/fetchPlacements`, {
      method: 'POST',
      headers: {
        // 'Content-Type': 'application/json',
        'auth_token': localStorage.getItem('auth_token')
  ...
  const getAllItems = async () => {
    const response = await fetch(`http://localhost:8000/api/item/getAllItems`, {
      method: 'GET',
      headers: {
        'auth_token': localStorage.getItem('auth_token')
      }
  ...
  const fetchPItem = async (_id) => {
    const response = await fetch(`http://localhost:8000/api/item/fetchPItem/${_id}`, {
      method: 'GET',
      headers: {
        // 'Content-Type': 'application/json',
        'auth_token': localStorage.getItem('auth_token')
  ...
  const getUserById = async (id) => {
    const response = await fetch(`http://localhost:8000/api/auth/getUserById/${id}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'auth_token': localStorage.getItem('auth_token')
  ...
  const getAllUsers = async () => {
    const response = await fetch(`http://localhost:8000/api/auth/getAllUsers`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
        'auth_token': localStorage.getItem('auth_token')
  ...
  const blockAUser = async (id) => {
    const response = await fetch(`http://localhost:8000/api/auth/blockAUser/${id}`, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
        'auth_token': localStorage.getItem('auth_token')
 ...
 //5. ****** add a noted ********
  const addnotes= async (data) => {
    setisAdded(false);
    const response = await fetch(`http://localhost:8000/api/item/addnotes`, {
      method: 'POST',
      headers: {
        'auth_token': localStorage.getItem('auth_token')
      },
  ...
  const fetchAllNotes= async () => {
    const response = await fetch(`http://localhost:8000/api/item/fetchAllNotes`, {
      method: 'POST',
      headers: {
        'auth_token': localStorage.getItem('auth_token')
      }
